...
## セットアップチェックリスト(人間側)
- [ ] ホスティング先の決定(GitHub Pages / Vercel)
- [ ] 独自ドメイン取得(任意、最初はサブドメインでも可)
...
## ディレクトリ構成
```
posts/        公開用記事(Markdown)
```

## 運用ログ
- 2026-09-25: 事業立ち上げ。初回記事「無料で使える文字起こしAIツール5選」を作成。
- 2026-09-25: 2本目の記事「AIライティングツールを選ぶ前に確認すべき7つのチェックポイント」を作成。
- 2026-09-25: 3本目の記事「AI画像生成ツールを商用利用する前に確認すべき5つのポイント」を作成。ホスティング(GitHub Pages/Vercel)の選定は人間側の意思決定・設定が必要なため未着手。次のアクションとして提案する。
